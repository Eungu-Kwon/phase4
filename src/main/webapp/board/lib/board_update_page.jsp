			...
			<div class="Article">
				...
				<div class="ArticleContentBox">
					...
					<div class="article_container">
						<form action="board_update_process.jsp?cid=<%=request.getParameter("cid")%>&tid=<%=request.getParameter("tid")%>&id=<%=request.getParameter("id")%>" method="post" accept-charset="utf-8">
							<div class="article_board">
								...
								<div class="mb-3">
									...
									<textarea class="form-control" id="exampleFormControlTextarea1"
										rows="6" name="content"><%=board.getContent()%></textarea>
								</div>
							</div>
