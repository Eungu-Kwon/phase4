          ...
          <%   
        	...
        	if (extraNum.equals("default")|| extraNum.equals("1")){
        		if (categoryNum.equals("default"))
        			...
        			query = "select cname,description,thumbnail from circle where category_id="+categoryNum+" and iscircle='Y'"; 
        		}
        	}
        	else{ //현재 모집 중인 동아리 
        		if (categoryNum.equals("default"))
        			query = "select cname,description,thumbnail from circle where iscricle='Y'";
        		else{
        			query = "select cname,description,thumbnail from circle where category_id="+categoryNum+"and iscircle='Y'"; 			
        		}
